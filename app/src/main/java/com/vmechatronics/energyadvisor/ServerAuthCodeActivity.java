...
public class ServerAuthCodeActivity extends AppCompatActivity implements
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_GET_AUTH_CODE) {
            ...
            if (result.isSuccess()) {
                ...
                updateUI(true);
                //Attention :connect the backend sever from below code
                HttpClient httpClient = new DefaultHttpClient();

                HttpPost httpPost = new HttpPost("www.vmechatronics.com");
                ...
                /*try {
                    ...
                    //String httpClient = GoogleApiClient
                   HttpResponse response = httpClient.execute(httpPost);
                    int statusCode = response.getStatusLine().getStatusCode();
                    final String responseBody = EntityUtils.toString(response.getEntity());
                } catch (ClientProtocolException e) {
                    Log.w(TAG, "Error sending auth code to backend.", e);
                } catch (IOException e) {
                    Log.w(TAG, "Error sending auth code to backend.", e);
                }*/
    ...
    private void validateServerClientID() {
        String serverClientId = getString(R.string.server_client_id);//need to add here server client id which  google cloud console generated
        String suffix =" accounts.google.com";
